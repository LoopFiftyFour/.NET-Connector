...
namespace Loop54.Tests
{
    ...
    public class CallMethods
    {
        ...
        [Test]
        public void GetEntitiesByAttributeWithAliasHasResults()
        {
            var alias = new GetEntitiesByAttributeRequest.RequestAliasData()
            {
                Name = "ManufacturerAlias",
                Value = "GrindersAlias",
                Details = "This request was generated by the .NET Connector tests."
            };

            //Should result in two flour products
            var request = new GetEntitiesByAttributeRequest("Manufacturer", "Grinders inc", alias);
